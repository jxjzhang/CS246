...
Subhabrata Mukherjee, etc published a paper that dealt with sentiment analysis of tweets. In their pre-processing work, they used a Twitter specific spellchecking algorithm, which utilized vowel exchange, dropping of vowels, text compression, squeeze, and edit distance methods. They had intended to also deal with phonetic transformation, segmentation with punctuation, segmentation with compound words, etc.
